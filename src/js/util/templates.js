...
function (stitchesTemplate, downloadsTemplate, spriteTemplate, cssTemplate, cssMarkupTemplate, lessTemplate, lessMarkupTemplate, scssTemplate, scssMarkupTemplate) {
    ...
    return {
        ...
        /**
         * ### @scssMarkup
         * Returns the scss markup template
         *
         * @return string
         */
        scssMarkup: function () {
